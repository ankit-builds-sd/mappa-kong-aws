...
export function efhfGoalMonitoring__q_scoreCard(
  ...
  const scTotalGoalsAchieved = efhfGoalMonitoring__st_countOfAllGoalStatusEquals;
  const scTotalGoalsTargeted = efhfGoalMonitoring__st_scTotalGoalsTargeted;
  const scTotalTargetsAchieved = efhfGoalMonitoring__st_countOfAllTargetStatusEquals;
  const scTotalTargetsTargeted = efhfGoalMonitoring__st_countOfAllTargetsStateEqualsOn;
...
export function efhfGoalMonitoring__q_goalNetZeroEnergy(
  ...
  const nzeProgressPercent = efhfGoalMonitoring__pi_energyServiceSustainabilityLevelPercentEnergySavings;
  const nzeCostPerSqft = efhfGoalMonitoring__pi_sumOfCapexInEnabledInterventionsInEnergyCategory / efhfGoalMonitoring__pi_projectBuiltUpArea;
...
export function efhfGoalMonitoring__q_nzeTargetMaximizeOnsiteRenewableEnergy(
  ...
  const moreMaxRenewableEnergySavings = efhfGoalMonitoring__pi_energyServiceEnergyPotentialRenewableEnergySavings;
  const moreMaxContributionPercent =
    (moreMaxRenewableEnergySavings * 100) / efhfGoalMonitoring__pi_energyServiceSustainabilityLevelAnnualBaselineEnergyConsumption;

  const moreAdditionalCost =
    efhfGoalMonitoring__pi_sumOfCapexInRenewableSourcesSubCategory - efhfGoalMonitoring__pi_sumOfCapexInEnabledInterventionsInRenewableSourcesSubCategory;

  const moreTier = moreMaxContributionPercent;

  const moreProgressPercent = efhfGoalMonitoring__pi_energyServiceConsumptionSubCategoriesRenewableEnergyPercent;
