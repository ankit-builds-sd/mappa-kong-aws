...
export function reverseTest__q_trial2(
  reverseTest__pi_pi1: number,
  reverseTest__pi_pi2: number
) {
  return reverseTest__pi_pi1 + reverseTest__pi_pi2;
}
export function reverseTest__q_yearlyConsumption(
  reverseTest__pi_1,
  reverseTest__st_dailyConsumption
) {
  return utilities.utility_calculateYearlyConsumption(
    reverseTest__st_dailyConsumption
  );
}
export function reverseTest__q_test1(
  reverseTest__st_yearlyConsumption: number
) {
  return (
